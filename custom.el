(custom-set-variables
 ...
 '(package-selected-packages
   '(corfu rust-mode vertico marginalia writeroom-mode use-package tree-sitter-langs tree-sitter go-mode lsp-mode lsp-pyright exec-path-from-shell lua-mode markdown-mode magit restart-emacs))
