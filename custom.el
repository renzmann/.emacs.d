(custom-set-variables
 ...
 '(package-selected-packages
   '(material-theme pyvenv company tree-sitter-langs tree-sitter nord-theme rust-mode go-mode lsp-mode lsp-pyright exec-path-from-shell lua-mode markdown-mode magit)))
(custom-set-faces
