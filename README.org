...
I don't use ~pyvenv~ much now though, since the vast majority of my development
time is spent over Tramp, which ~pyvenv~ does not support.
...
Protocol]].  Enabling that mode would look like this:
