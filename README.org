...
With the introduction of =modus-vivendi-tinted= in Emacs 29, I really have no need for any
external themes now.  It is accessible, well optimized for =org-mode= and
=prog-mode=, and distributed with vanilla Emacs.  Hats off to [[https://protesilaos.com/][Prot]] for these
wonderful themes.
