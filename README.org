...
** TODO COMMENT Slight startup hit
...
** COMMENT Org babel async ~ob-async~
...
* COMMENT Language server protocol (LSP) with =eglot=
...
* COMMENT eww - search engine and browser
...
- [ ] Opening this README takes too long.  Guess we need to split it up after all.
- [ ] Boot time is too slow for my taste.  I'd like TTY version to stay snappy.
