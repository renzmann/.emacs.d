...
I store something like the above in a =proxy.el= file with HOST, PORT, LOGIN, and
PASSWORD filled out (obviously outside of version control).
...
** TODO Shorter file paths in grep/compilation buffers
