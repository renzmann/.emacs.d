...
[[https://archive.casouri.cc/note/2023/tree-sitter-in-emacs-29/index.html][recommended workaround]] is to derive a mode that picks between them.  So, what we
...
Each major mode that I want automatic fallback for will have this mode added to [[* Language-specific major modes][its
