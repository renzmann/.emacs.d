...

;;;### (autoloads nil "corfu-popup" "corfu-popup.el" (0 0 0 0))
;;; Generated autoloads from corfu-popup.el

(define-obsolete-function-alias 'corfu-popup-mode 'corfu-terminal-mode "0.1")
