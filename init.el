...
(custom-set-variables
 ...
 '(package-selected-packages
   '(diff-hl ox-hugo minimap tramp restart-emacs gnuplot corfu-terminal corfu esup consult org-roam ob-async sqlup-mode sql-indent ripgrep blacken lsp-mode sqlformat pythonic f s reformatter change-inner vterm magit vertico tree-sitter-langs tree-sitter orderless ob-sql-mode yaml-mode exec-path-from-shell vimrc-mode csv-mode haskell-mode julia-mode lua-mode go-mode scala-mode rust-mode ef-themes markdown-mode eglot marginalia)))
(custom-set-faces
